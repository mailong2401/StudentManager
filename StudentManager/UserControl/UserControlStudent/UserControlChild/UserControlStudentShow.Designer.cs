namespace StudentManager
{
    partial class UserControlStudentShow
    {
        ...
        private void InitializeComponent()
        {
            ...
            // tableStudent
            // 
            tableStudent.ColumnCount = 1;
            tableStudent.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            tableStudent.Controls.Add(exampleBox, 0, 0);
            tableStudent.Location = new Point(47, 184);
            tableStudent.Name = "tableStudent";
            tableStudent.RowCount = 12;
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            ...
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.RowStyles.Add(new RowStyle(SizeType.Percent, 8.333332F));
            tableStudent.Size = new Size(1483, 564);
            tableStudent.TabIndex = 20;
            // 
            // exampleBox
            // 
            exampleBox.Alpha = 20;
            ...
            exampleBox.Location = new Point(3, 3);
            ...
            label2.Location = new Point(235, 141);
            label2.Name = "label2";
            ...
            label3.Location = new Point(601, 141);
            label3.Name = "label3";
            ...
            label4.Location = new Point(799, 141);
            label4.Name = "label4";
            ...
            label5.Location = new Point(922, 141);
            label5.Name = "label5";
            ...
            label6.Location = new Point(1122, 141);
            label6.Name = "label6";
            ...
            label8.Location = new Point(1300, 141);
            label8.Name = "label8";
            ...
            inputidKhoa.PlaceholderText = "Nhập tên sinh viên";
